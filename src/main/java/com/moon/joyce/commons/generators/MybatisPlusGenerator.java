package com.moon.joyce.commons.generators;
 ...
 */public class MybatisPlusGenerator {
    ...
    public static void executeGenerator(String str){
        // 1、创建代码生成器
...
// 3、数据源配置
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/springboot?serverTimeZone=GMT%2B8");
